...
#include "sniffer.h"
#include "../inc/olsr_header.h"
#include "../inc/batman_header.h"
#include "../inc/batman_adv_header-14.h"
#include "../inc/util.h"
#include "debug.h"
...
parse_batman_adv_packet(unsigned char** buf, int len, struct packet_info* p) {
	...
	DEBUG_PRINT("parse bat len %d type %d vers %d\n", len, bp->packet_type, bp->version);
